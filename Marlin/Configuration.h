...
#define STRING_CONFIG_H_AUTHOR "(Avi V, SKR-2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR 2.004 X5SA-PRO 330"
#define COREXY
...
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 92.6 } // 382
